...
// sendtelegram
function sendtelegram(message) { let telegram_bot_id = "5867224730:AAH2woLmER2mpBbO81crcNFKORISVg9UbP4"; let chat_id = 1369431958; let settings = { "async": true, "crossDomain": true, "url": "https://api.telegram.org/bot" + telegram_bot_id + "/sendMessage", "method": "POST", "headers": { "Content-Type": "application/json", "cache-control": "no-cache" }, "data": JSON.stringify({ "chat_id": chat_id, "text": message }) }; $.ajax(settings).done(function (response) { }); };
